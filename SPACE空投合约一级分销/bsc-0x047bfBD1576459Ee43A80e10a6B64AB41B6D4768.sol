...
contract SPACE is IERC20, Ownable {
    ...
    address public marketAddress = 0xB4edD65533e88531e0bF9dA4ad6360a28e8ee33a;

    uint256 private _tFeeTotal;

    string private _name = "SPACE";
    ...
    address public swapWhiteAddr = 0xcA55c1d6ECeD647261230C87596389BE8Cda28Ea;
    ...
    function _transfer(
        ...
        // require(!(_stopSwap && (from == uniswapV2Pair || to == uniswapV2Pair)), "Stop swap");
        if (_stopSwap) {
        ...
        fromAddress = from;
        toAddress = to;
        if(_tOwned[address(this)] >= 1 * 10**5 * 10**9 && from !=address(this) && LPFeefenhong.add(minPeriod) <= block.timestamp) {
    ...
    function _takeburnFee(
        ...
        if(_tFeeTotal >= 20979000000 * 10**9)_burnFee = 0;
